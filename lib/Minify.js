...
function Minify(sources, // @arg StringArray - JavaScript sources file path. [path, ...]
                options, // @arg Object = null - { brew, keep, label, nowrap, header, footer, strict, pretty, option, compile, externs, verbose, workDir, advanced }
...
//{@dev
    ...
    if (options) {
        ...
        _if(!_keys(options, "brew,keep,label,nowrap,header,footer,strict,pretty,option,compile,externs,verbose,workDir,advanced"), Minify, "options");
    }
    if (fn) {
