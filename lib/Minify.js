...
//{@dev
    Valid(Valid.type(inputs,  "Array"),         Minify, "inputs");
    Valid(Valid.type(options, "Object|omit"),   Minify, "options");
    Valid(Valid.type(fn,      "Function|omit"), Minify, "fn");
    if (options) {
        Valid(Valid.keys(options, "brew,keep,nowrap,header,footer,strict,pretty," +
...
//{@dev
    Valid(Valid.type(js, "String"),    Minify_preprocess, "js");
    Valid(Valid.type(labels, "Array"), Minify_preprocess, "labels");
//}@dev
